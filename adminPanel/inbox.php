						...
						<div class="inbox-page">
							...
							<div class="inbox-row widget-shadow" id="accordion1" role="tablist" aria-multiselectable="true">
								...
								<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
									<div class="mail">
										<p>Mollis nullam quis risus eget ornare accusamus terry </p>
									</div>
								</a>
								<div class="mail-right dots_drop">
									<div class="dropdown">
							...
							<div class="inbox-row widget-shadow">
								...
								<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapsethree">
									<div class="mail">
										<p>Ornare vel eu leo nullam quis urna mollis accusamus terry </p>
									</div>
								</a>
								<div class="mail-right dots_drop">
									<div class="dropdown">
							...
							<div class="inbox-row widget-shadow">
								...
								<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
									<div class="mail">
										<p>Vely Ornare leo nullam quis risus mollis lorem ipsum</p>
									</div>
								</a>
								<div class="mail-right dots_drop">
									<div class="dropdown">
						...
						<div class="inbox-page row">
							...
							<div class="inbox-row widget-shadow">
								...
								<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
									<div class="mail">
										<p>Mollis nullam quis risus eget urna ornare dolor sit amet</p>
									</div>
								</a>
								<div class="mail-right dots_drop">
									<div class="dropdown">
							...
							<div class="inbox-row widget-shadow">
								...
								<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="true" aria-controls="collapsesix">
									<div class="mail">
										<p>Nullam quis risus eget urna mollis ornare eiusmod accusamus</p>
									</div>
								</a>
								<div class="mail-right dots_drop">
									<div class="dropdown">
							...
							<div class="inbox-row widget-shadow">
								...
								<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSev" aria-expanded="true" aria-controls="collapsesev">
									<div class="mail">
										<p>Ornare vel eu leo nullam quis urna mollis eiusmod high life</p>
									</div>
								</a>
								<div class="mail-right dots_drop">
									<div class="dropdown">
							...
							<div class="inbox-row widget-shadow">
								...
								<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseEight" aria-expanded="true" aria-controls="collapseEight">
									<div class="mail">
										<p>Vely Ornare leo nullam eget urna mollis lorem ipsum</p>
									</div>
								</a>
								<div class="mail-right dots_drop">
									<div class="dropdown">
