...
<body>
			...
			<div class="main-page login-page ">
				...
				<div class="widget-shadow">
					<div class="login-body">
						<form method="post">
							<input type="email" class="user" name="uname" placeholder="Enter Your Email" required="">
	...
	if (isset($_POST['SignIn'])) {
		...
		if ($username == "" && $password == "") {
			...
			} else if (empty($_SESSION['userrole'])) {
				echo "<script>alert('Please Confirm Your Email And Password')</script>";
			}
		}
	}
