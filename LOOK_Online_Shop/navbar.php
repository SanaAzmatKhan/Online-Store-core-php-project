	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="index.php"><img src="images/logo.png" class="logo_agile" alt=""><span>Look</span><h6>ONLINE SHOP</h6><i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
								...
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="collection.php"><img src="images/top2.jpg" alt=" "/></a>
											...
											<?php $i=0; foreach($result22 as $row22){?>
												<?php if($i%2==1){ ?>
